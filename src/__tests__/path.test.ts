...
describe('path', () => {
    ...
    describe('wayPoints', () => {
        ...
        it('with two points', () => {
            ...
            const expected =
                'origin=' + encodeURIComponent('8th Avenue & 34th St, New York, NY') +
                '&destination=' + encodeURIComponent('Park Ave & 42nd St,New York,NY,NY');
        ...
        it('with waypoints', () => {
            ...
            const expected =
                'origin=' + encodeURIComponent('8th Avenue & 34th St, New York, NY') +
                '&destination=' + encodeURIComponent('Willis Tower, Chicago, IL') +
                '&waypoints=' + encodeURIComponent('|Park Ave & 42nd St,New York,NY,NY');
